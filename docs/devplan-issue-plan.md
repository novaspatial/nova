...
| 2 | [#13](https://github.com/novaspatial/nova/issues/13) **S17** | **Admin file download** — consume `signedDownload` (+ `requireProjectChild`) from the #35 seam. | `ready-for-agent` (flipped 2026-07-24 when #35 landed; was stale `ready-for-human`). |
...
**Lifecycle queue:** D7b ─> [#27](https://github.com/novaspatial/nova/issues/27) **S18** delivery anchor + 90-day purge (D7 answered 2026-07-14: Vercel Cron, purge covers stems + deliverables; only the record question — hard-delete vs tombstone — remains. Reuses `projectCleanup` + the shipped #35 storage seam (`bucketFor`/`removeStorageObjects`); stamps `delivered_at` at the PATCH transition point the shipped #34 seam made explicit). Independent of decisions: [#13](https://github.com/novaspatial/nova/issues/13) **S17** admin file download — unblocked since #35 landed (2026-07-24, label flipped `ready-for-agent`; now row 2 of the Now queue).
...
(#23, the former no-gate top of this path, shipped 2026-07-04; #40/#41 shipped 2026-07-08; #9/#31/#38/#25 shipped 2026-07-13; #26 shipped 2026-07-15; #30, #19, #24, and the #35/#37 arch slice shipped 2026-07-24.) **The commerce critical path is complete.** Everything remaining (#42/#43, #33, #13, #27, #29, #36, #39) is parallel-safe, gated only by D7b/D12 and the ops inputs named in their Notes.
...
| S17 | [#13](https://github.com/novaspatial/nova/issues/13) | ready-for-agent | Admin file download |
...
Closed: #2–#12, #14–#26, #30, #31, #32, #34, #35, #37, #38, #40, #41 (see Completed; #28 is a merged PR, not an issue).
