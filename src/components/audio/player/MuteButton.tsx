...
export function MuteButton({ player }: { player: AudioPlayerAPI }) {
  return (
    <button
      type="button"
      className="group relative rounded-md hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-900 md:order-first"
