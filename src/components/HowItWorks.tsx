  ...
  return (
    <FadeIn>
      <div className="group relative flex items-center justify-center lg:justify-start">
        ...
        {/* Number circle */}
        <div className="absolute left-1/2 top-4 z-10 flex size-8 -translate-x-1/2 items-center justify-center rounded-full bg-linear-to-br from-indigo-900/80 via-violet-800/80 to-purple-900/80 text-xs font-bold text-white ring-1 ring-white/20 transition-all duration-300 group-hover:scale-110 group-hover:ring-white/30 sm:size-10 sm:text-sm lg:top-6 3xl:size-12 3xl:text-base">
          {step.number}
        </div>
        ...
        >
          <div className="group rounded-xl bg-white/3 p-4 ring-1 ring-white/10 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:bg-white/6 hover:ring-white/20 hover:shadow-xl hover:shadow-violet-500/20 sm:p-5 3xl:p-6">
          {/* Header row: title + icon */}
          <div className="flex items-center justify-between gap-3">
            <h3 className="font-display text-sm font-semibold text-white sm:text-lg 3xl:text-xl">
              {step.title}
            </h3>
            <div className="flex shrink-0 size-7 items-center justify-center rounded-lg bg-white/5 ring-1 ring-white/10 transition-all duration-300 group-hover:scale-110 group-hover:bg-white/10 group-hover:ring-white/20 sm:size-8 3xl:size-9">
          ...
          <button
            ...
            className="mt-2 flex items-center gap-1.5 text-[10px] font-medium text-white/80 transition-all duration-200 hover:gap-2 hover:text-white sm:mt-3 sm:text-xs 3xl:text-sm"
          >
            ...
            {trustBadges.map(({ icon: Icon, label }) => (
              <FadeIn key={label}>
                <div className="group flex cursor-default items-center gap-1.5 transition-all duration-300 hover:scale-105 3xl:gap-2">
                  <Icon className="size-3.5 text-neutral-500 transition-colors duration-300 group-hover:text-violet-400 sm:size-4 3xl:size-5" />
                  <span className="text-[10px] text-neutral-500 transition-colors duration-300 group-hover:text-neutral-300 sm:text-xs 3xl:text-sm">
                    {label}
                  </span>
                </div>
              </FadeIn>
